...
<body>
  ...
  <main>
    ...
    <section id="about">
      ...
      <p><strong>Nama Orang Tua:</strong> Bapak Marwadi Dan Ibu Ngatinah</p>
      <p><strong>Nama Kakak:</strong> Indah Nuryanto</p>
      <p><strong>Nama Adik:</strong> Tidak Ada <?php echo $sespesan ?></p>
    </section>
  ...
  <form action="proses.php" method="POST">
    ...
    <label>
      ...
      <input type="text" name="Tanggal" placeholder="Masukkan Tanggal Lahir" required>
    </label>

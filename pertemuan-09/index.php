...
<body>
  ...
  <main>
    ...
    <section id="biodata">
      ...
      $fieldconfig = [
       "nim" => ["label" => "nim:", "sufflix" => ""],
       "nama" => ["label" => "nama lengkap:", "sufflix" => "&#128526;"],
       "tempat" => ["label" => "tempat lahir:", "sufflix" => ""],
       "tanggal" => ["label" => "tanggal lahir:", "sufflix" => ""],
       "hobi" => ["label" => "hobi:", "sufflix" => "&#127926;"],
       "pasangan" => ["label" => "pasangan:", "sufflix" => "&#hearts"],
       "pekerjaan" => ["label" => "pekerjaan:", "sufflix" => ""],
       "ortu" => ["label" => "nama orang tua:", "sufflix" => ""],
       "kakak" => ["label" => "nama kakak:", "sufflix" => ""],
       "adik" => ["label" => "nama adik:", "sufflix" => ""],
      ];
      ?>
